...
INSERT INTO `administrator` VALUES (10,0,'\0','robledo@gmail.com','Manuel','+34 956999111','Robledo',9);
...
CREATE TABLE `applyfor` (
  ...
  PRIMARY KEY (`id`),
  KEY `UK_oj7drhuqob01gb1mxiwauofh3` (`status`),
  KEY `FK_btlpsnbkpuuv0j9ylpmw9552r` (`customer_id`),
  CONSTRAINT `FK_btlpsnbkpuuv0j9ylpmw9552r` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `applyfor` WRITE;
/*!40000 ALTER TABLE `applyfor` DISABLE KEYS */;
/*!40000 ALTER TABLE `applyfor` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `banner` (
  ...
  `isPrincipal` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `banner` VALUES (6,0,'http://i64.tinypic.com/qqeech.jpg',''),(7,0,'http://i66.tinypic.com/vfy1hv.jpg','\0'),(8,0,'http://i67.tinypic.com/212fic6.jpg','\0');
...
CREATE TABLE `deal` (
  ...
  `customer_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_th3qb1nqrrvaj9r0qad4430df` (`customer_id`),
  CONSTRAINT `FK_th3qb1nqrrvaj9r0qad4430df` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `message_attachment` (
  ...
  KEY `FK_khd2rtvmj1021tdbhmv82v8yv` (`Message_id`),
  CONSTRAINT `FK_khd2rtvmj1021tdbhmv82v8yv` FOREIGN KEY (`Message_id`) REFERENCES `message` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `offer` (
  ...
  `customer_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_bs106o9u5uk811v0drkkytyn7` (`customer_id`),
  CONSTRAINT `FK_bs106o9u5uk811v0drkkytyn7` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-28 11:49:10
