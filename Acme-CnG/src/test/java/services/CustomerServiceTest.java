...
public class CustomerServiceTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		for (int i = 1; i < testingData.length; i++) {
			templateCreate((String) testingData[i][0], (String) testingData[i][1],(String) testingData[i][2],(String) testingData[i][3],(String) testingData[i][4],(Boolean) testingData[i][5],(String) testingData[i][6],(String) testingData[i][7],(Class<?>) testingData[i][8]);
		}
	}

	protected void templateCreate(String username, String password, String password2, 
			String name, String surname, Boolean agreed, String email, String phone, Class<?> expected) {
		Class<?> caught;
