...
public class CommentServiceTest extends AbstractTest{
	...
	public void driveBanUnbanComment(){
		Object testingData[][] = {
			{"admin", 77, null}, // Marcamos como no apropiado un comentario.
			{"customer3", 77, IllegalArgumentException.class}, // Un cliente intenta marcar como inapropiado un comentario.
			{"admin", 78, null}, // Marcamos como apropiado un comentario que estaba marcado como inapropiado.
			{"customer3", 78, IllegalArgumentException.class} // Un cliente intenta marcar como apropiado un comentario que estaba marcado como inapropiado.
		};
	...
	public void drivePostComment(){
		Object testingData[][] = {
			{"admin", 52, null}, // Un administrador escribe un comentario en el perfil de otro actor del sistema.
			{"customer2", 62, null}, // Un cliente escribe un comentario en una offer.
			{"customer1", 65, null}, // Un cliente escribe un comentario en una request.
			{null, 64, IllegalArgumentException.class} // Un usuario no registrado intenta escribir un comentario.
		};
