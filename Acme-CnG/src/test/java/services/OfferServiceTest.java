...
public class OfferServiceTest extends AbstractTest {
	...
	protected void templateCreate(String user, String title, String description, 
			String moment, String origin, String Xorigin, String Yorigin, 
			String destination, String Xdestination, String Ydestination, Class<?> expected) {
		Class<?> caught;
		...
		try {
			...
			OfferForm offerForm;
			offerForm = offerService.generate(); //Creamos una applyFor .
